/* ============================================================
 * Bullseye Rings — a Qlik Sense visualization extension
 *
...
define(["qlik", "text!./style.css", "./properties"], function (qlik, css, properties) {
  ...
  if (!document.getElementById("by-style")) {
    var styleTag = document.createElement("style");
    styleTag.id = "by-style";
  ...
  function render(self, el, layout, rows) {
    ...
    var H = Math.max(20, st.root.clientHeight - (o.showLegend ? st.legendEl.offsetHeight : 0));
